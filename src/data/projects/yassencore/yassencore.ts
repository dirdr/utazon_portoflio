  ...
  showcases: [
    {
      ...
      order: 1,
      video: {
        src: "https://utazon-backend.adrienpelfresne.com/api/videos/yassencore/details1.mp4",
    ...
    },
    {
      ...
      order: 2,
      video: {
        src: "https://utazon-backend.adrienpelfresne.com/api/videos/yassencore/details2.mp4",
