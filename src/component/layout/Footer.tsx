          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <a href="/" className="text-base md:text-lg mb-1">
                  {t("common.utazon")}
                </a>
                <a href="/" className="text-muted text-xs md:text-sm">
                  {t("common.antoine_vernez")}
                </a>
              </div>
            </div>
            <nav className="flex flex-col items-start md:items-start">
              <h4 className="text-muted text-sm md:text-base mb-3">Menu</h4>
              <Link
                href={ROUTES.PROJECTS}
                onClick={handleProjectsClick}
                className="text-white hover:text-white transition-colors duration-200 mb-2 text-sm md:text-base"
              >
                {t("nav.projects")}
              </Link>
              <Link
              ...
              <Link
                ...
                className="text-white hover:text-white transition-colors duration-200 text-sm md:text-base"
              >
                {t("nav.contact")}
              </Link>
            </nav>
            ...
            <div className="flex flex-col items-start gap-3">
              <h4 className="text-muted text-sm md:text-base mb-0">Socials</h4>
              <a
